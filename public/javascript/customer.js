...
categoryList.addEventListener("mouseleave", () => {
  const containers = document.querySelectorAll(".category_container__first-order")
...
async function getFirstOrderCategory() {
  ...
  const firstOrderContainer = document.querySelector(".category_container__first-order")
  console.log(firstOrderContainer.offsetWidth)
  displayCategoryList(firstOrderContainer, res.data,firstOrderContainer.offsetWidth,0)
